...
elseif (CPPUTEST_STD_C)
    set(CPP_PLATFORM Gcc)
else (MSVC)
    set(CPPUTEST_STD_CPP False)
    set(CPPUTEST_MEMORY_LEAK_DETECTION False)
...
if (NOT CPPUTEST_STD_CPP)
    set(CPPUTEST_STD_CPP_LIB_DISABLED 1)
    if (CPPUTEST_STD_C AND NOT MSVC)
        set(CPPUTEST_CXX_FLAGS "${CPPUTEST_CXX_FLAGS} -nostdinc++")
    endif (CPPUTEST_STD_C AND NOT MSVC)
endif (NOT CPPUTEST_STD_CPP)

if (CPPUTEST_MEMORY_LEAK_DETECTION)
    if (MSVC)
...
endif (CPPUTEST_COVERAGE AND NOT MSVC)
...
endif (CPPUTEST_GMOCK)

if (CPPUTEST_REAL_GTEST AND NOT CPPUTEST_USE_REAL_GTEST)
...
endif (CPPUTEST_REAL_GTEST AND NOT CPPUTEST_USE_REAL_GTEST)
