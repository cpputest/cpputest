...
if (TESTS_DETAILED)
  ...
  foreach(testfullname ${TestList_GroupsAndNames})
    ...
    message("... ${testname}")
    buildtime_add_test(${EXECUTABLE_SHORT_NAME}.${testfullname} ${EXECUTABLE} -sg ${groupname} -sn ${testname} -c)
  endforeach()
else (TESTS_DETAILED)
  set(DISCOVER_ARG "-lg")
  ...
  foreach(group ${TestList_Groups})
    ...
    buildtime_add_test(${EXECUTABLE_SHORT_NAME}.${group} "${EXECUTABLE}" -sg ${group} -c)
  endforeach()
